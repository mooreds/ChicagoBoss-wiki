...
<p><em>DRAFT: September 7, 2010</em> (<a href="#changes">changes</a>)</p>

<p><strong>11/5/2011 NOTE: The following tutorial is out of date. Please contact me if you are interested in making a new tutorial for the 0.6.x series. -EMM</strong></p>
...
<div class="quote">
    <p>&#8220;Well, what's in it for me?&#8221; &mdash;You</P>
</div>
...
<div class="quote">
"You leave the thinkin' to me." &mdash;Boss
</div>

<h3>II.0. Table of Contents</h3>
<p>Here's the roadmap, pilgrim:</p>
<ol>
    <li><a href="#learning-erlang">Learning Erlang</a></li>
    <li><a href="#installing-erlang">Installing Erlang</a></li>
    <li><a href="#my-first-boss">My First Boss</a></li>
    <li><a href="#essential-tricks">Essential Tricks: /admin and /doc</a></li>
    <li><a href="#model-view-controller">Model, View and Controller</a></li>
    <ol>
    ...
    <li><a href="#associations">Associations: belongs_to and has</a></li>
    <li><a href="#logins">How To Implement Log-ins</a></li>
    <li><a href="#login-info">How To Actually Use Log-In Information</a></li>
    <li><a href="#validate">How To Validate Input</a></li>
    <li><a href="#logout">How To Implement A Log-Out</a></li>
    <li><a href="#rss-feed">How To Implement an RSS feed</a></li>
</ol>
...
<p>Those 3 chapters have 99% of what you need. Read Chapter 4 (Exceptions) once you've built a few things and need extra robustness. But otherwise, you don't need to worry about compiling, concurrency, the process model, server loops, or any of the other things Erlang is celebrated for. Boss takes care of it.</p>
...
<p>For this tutorial, we'll use an in-memory database, so there's nothing to install. When you want to get serious, check out <a href="#meet-tyrant">Appendix A: Meet The Tyrant</a>.</h3>

<a name="my-first-boss"></a>
<h3>II.4. My First Boss</h3>
...
<div class="figure">
<img src="images/boss-guide-new-voter.png" style="border: 1px solid black;" />
</div>
...
<p>This file will be a template written in the <a href="http://www.djangoproject.com/documentation/0.96/templates/">Django Template Language</a>. Let's put a dumb little list into our template:</p>
...
&lt;p&gt;&lt;a href="/user/login"&gt;Log in&lt;/a&gt;&lt;/p&gt;
    ...
    <p>Not to worry&mdash;go back to the Chicago Boss shell, the one with all the PROGRESS REPORTs that we did all the work in before. Type:</p>
...
<p>So to ensure <span class="code">before_</span> is invoked, we need to modify the actions to take a third argument. Modify the controller's function definitions like so:</span>
...
<p><a href="ttserver">Download my <span class="code">/etc/init.d/ttserver</span></a></p>
...
<p><em><a href="/">Back to Evan Miller's home page</a></em></p>
